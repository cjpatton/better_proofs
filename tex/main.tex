...
\paragraph{OCB2.}
%
OCB2 (``Offset CodeBook'') is a blockipher mode of operation that provides for
authenticated encryption standardized by ISO (ISO/IEC 19772:2009). In
...
\paragraph{GCM.}
%
GCM (``Galois Counter Mode'') is a mode of operation for AES that has been
recommended by NIST since 2007 and is widely used at IETF and beyond.
%
