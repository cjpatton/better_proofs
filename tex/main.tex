...
appeared in standards in the 90s.
%
...
%
The original security proof was later (Crypto 2001) shown to be
flawed~\cite{Sho01}. The author goes a bit further, proving there is \emph{no}
black-box reduction from the trapdoor permutation to the security of OAEP.
%
However, the author also shows that the flaw does not translate into an attack
