...
Today, carefully checking computational security proofs remains a significant
challenge. There are at least three exacerbating factors:
%
\begin{enumerate}
  ...
  \item Mechanization of security proofs can help reduce burden on human
    ...
    \href{https://github.com/SSProve/ssprove}{SSProve},\footnote{We don't
    include tools like \href{https://tamarin-prover.com/}{Tamarin} or
    \href{https://bblanche.gitlabpages.inria.fr/proverif/}{ProVerif} in this
    list because these are specialized for checking symbolic properties of
    cryptosystems, not computational ones.} but these tools remain somewhat
    inaccessible to many folks writing pen-and-paper proofs today.
    %
...
\end{enumerate}
%
These factors put our community on a trajectory that, in our view, is not be
sustainable long term.
%
We must therefore find ways to reduce the cost of checking security proofs so
