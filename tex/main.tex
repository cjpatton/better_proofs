...
\end{lstlisting}
  \caption{Syntax and real security game for PRPs and PRFs.}
...
\end{lstlisting}
  \caption{Ideal games for defining security of PRP and PRFs.}
  \label{fig/func/ideal-prp}
  \label{fig/func/ideal-prf}
\end{figure}
